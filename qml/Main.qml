        ...
        Flickable {
            ...
            ColumnLayout {
                ...
                Label{
                    ...
                    text: i18n.tr("This is a proof of concept of a new mode for the desktop environment Lomiri wherein some system gestures are disabled to help the user focus on the current app they're using without much distractions.\n\nThis is specially useful for apps that require different in-app gestures that could conflict with system gesture such as painting/drawing apps and games.\n\nI call this Immersive mode because I feel like it best describes its purpose. However, it's somewhat borrowed from Android so if you can think of a better name then let me know :)")
                    wrapMode: Text.Wrap
                }
                ...
                Label{
                    ...
                    text: i18n.tr("When Immersive mode is enabled, left and right edge gestures are disabled. This means you can't swipe from the left to open the launcher or the app drawer and you can't open the app spread from the right edge. This is all it does at the moment but if ever this actually gets into Lomiri officially, maybe some other gestures can also be disabled such as the 3-finger gestures in tablets.")
                    wrapMode: Text.Wrap
                }
                ...
                Label{
                    ...
                    text: i18n.tr("Left and right edges are disabled by simply setting Lomiri's GSettings key <i>Edge Drag Width</i> to 0. This settings can also be adjusted via UT Tweak Tool but the range there is only limited to 1-6.")
                    wrapMode: Text.Wrap
                }
